...
export default function SupportPage() {
  ...
  async function sendMessage(event: FormEvent) {
    ...
    setMessage("");
    try {
      await api(`/api/v1/support/conversations/${selectedId}/messages`, { method: "POST", body: { message: text } });
